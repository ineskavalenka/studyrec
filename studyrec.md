...
| № | Subject <br> Предмет                                       |	exam <br> Экзамен/Зачет |
| - | ---------------------------------------------------------- | ------------------- |
| 1 | Mathematical analysis <br> Математический анализ	| 7 |
| 2	| General and Theoretical Physics <br> Общая физика	| 7 |
| 3	| Numerical Methods <br> Численные методы |	5 |
| 4	| Imitational and Statistical Simulation <br> Имитационное и статистическое моделирование	 | +	|	
| 5	| Applied Programming <br> Прикладное программирование | + |
| 6	| Physical Culture (Sports) <br> Физическая культура | + |
| 7	| Differential equations <br> Дифференциальные уравнения | 4 |
| 8 | Theory of Probability and Elements of Statistics <br> Теория вероятностей и математическая статистика	|	6 |
				
### (4) 2nd year, spring term / 2 курс, весенняя сессия
| № | Subject <br> Предмет                                       |	exam <br> Экзамен/Зачет |
| - | ---------------------------------------------------------- | ------------------- | 	
| 1	| General and Theoretical <br>  Physics Общая физика | 7 |	
| 2	| Fundamentals of Electronics <br> Основы радиоэлектроники |	8 |
...
### (5) 3 year, winter term /	3 курс, зимняя сессия	
| № | Subject <br> Предмет                                       |	exam <br> Экзамен/Зачет |
| - | ---------------------------------------------------------- | ------------------- | 		
| 1 | General and Theoretical <br> Physics Общая физика  | 		6 | 
| 2 | Networks <br> Компьютерные сети	 | +	 | 		
| 3 | Operating Systems  <br> Операционные системы	 | +	 | 
| 4 | Fundamentals of Information Security <br> Основы информационной безопасности | 	+	 | 
| 5 | Fundamentals of Entrepreneurship and Business Спец. модуль "Основы предпринимательства и бизнеса"	 | +	  | 
| 6 | Physical Culture (Sports) Физическая культура	 | +  | 	
| 7 | Integrated Circuits <br> Интегральная электроника		 | 9 | 
| 8 | Methods of Mathematical Physics <br> Методы математической физики		 | 	4 | 
| 9 | Microprocessors and computer hardware <br> Микропроцессоры и аппаратные средства вычислительной техники | 8 | 
| 10 | Applied Programming <br> Технологии программирования		 | 	8 | 
	
### (6) 3rd year, spring term / 3 курс, весенняя сессия
| № | Subject <br> Предмет                                       |	exam <br> Экзамен/Зачет |
| - | ---------------------------------------------------------- | ------------------- | 
